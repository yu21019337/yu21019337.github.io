...
(function () {
    ...
    function createButton() {
        ...
        // 長按拖曳
        btn.addEventListener("touchstart", startLongPressDrag, { passive: false });
    ...
    function startLongPressDrag(e) {
        ...
        dragStartX = clientX;
        dragStartY = clientY;
        offsetX = rect.left + rect.width / 2 - clientX;
        offsetY = rect.top + rect.height / 2 - clientY;
    ...
    function handleDrag(e) {
        ...
        const rect = btn.getBoundingClientRect();
        const newLeft = clientX + offsetX - rect.width / 2;
        const newTop = clientY + offsetY - rect.height / 2;
